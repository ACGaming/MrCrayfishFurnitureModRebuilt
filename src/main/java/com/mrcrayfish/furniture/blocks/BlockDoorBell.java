...
public class BlockDoorBell extends BlockFurniture
{
    ...
    public BlockDoorBell(Material material, String id)
    {
        super(material, id);
    ...
    {
        return this.getDefaultState().withProperty(FACING, this.canPlaceBlockOnSide(worldIn, pos, facing) ? facing.getOpposite() : EnumFacing.NORTH).withProperty(POWERED, Boolean.FALSE);
    }
