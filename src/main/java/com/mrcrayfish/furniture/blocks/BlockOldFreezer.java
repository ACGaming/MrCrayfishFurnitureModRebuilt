...
public class BlockOldFreezer extends BlockFurnitureTile
{
    ...
    public BlockOldFreezer(Material material, String id)
    {
        super(material, id);
    ...
    {
        worldIn.setBlockState(pos.up(), FurnitureBlocks.FRIDGE_OLD.getDefaultState().withProperty(FACING, state.getValue(FACING)));
    ...
    {
        if(worldIn.getBlockState(pos.up()).getBlock() == FurnitureBlocks.FRIDGE_OLD)
        {
