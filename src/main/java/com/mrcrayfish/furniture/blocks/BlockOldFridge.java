...
public class BlockOldFridge extends BlockFurnitureTile
{
    ...
    public BlockOldFridge(Material material, String id)
    {
        super(material, id);
    ...
    {
        if(worldIn.getBlockState(pos.down()).getBlock() == FurnitureBlocks.FREEZER_OLD)
        {
    ...
    {
        return new ItemStack(FurnitureBlocks.FREEZER_OLD).getItem();
    }

    @Override
    public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player)
    {
        return new ItemStack(FurnitureBlocks.FREEZER_OLD);
    }
