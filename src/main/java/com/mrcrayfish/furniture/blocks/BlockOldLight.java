 ...
 */
public class BlockOldLight extends Block implements IPowered {
    ...
    public BlockOldLight(String id, boolean powered) {
    ...
    public void setPowered(World world, BlockPos pos, boolean powered) {
        ...
        if (powered) {
            world.setBlockState(pos, FurnitureBlocks.OLD_LIGHT_ON.getDefaultState().withProperty(FACING, facing));
        } else {
            world.setBlockState(pos, FurnitureBlocks.OLD_LIGHT_OFF.getDefaultState().withProperty(FACING, facing));
        }
    }
}
