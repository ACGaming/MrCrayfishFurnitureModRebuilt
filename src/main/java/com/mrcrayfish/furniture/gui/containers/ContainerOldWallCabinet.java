...
public class ContainerOldWallCabinet extends Container
{
    private IInventory wallCabinetInventory;

    public ContainerOldWallCabinet(IInventory playerInventory, IInventory wallCabinetInventory)
    {
        ...
        for(int i = 0; i < 3; i++)
        {
            for(int j = 0; j < 9; ++j)
            {
                this.addSlotToContainer(
                        new Slot(playerInventory, j + i * 9 + 9, j * 18 + 8, i * 18 + 115)
                );
            }
        }
        ...
        {
            this.addSlotToContainer(
                    new Slot(playerInventory, i, i * 18 + 8, 173)
            );
        }
    }
    ...
    {
        return this.wallCabinetInventory.isUsableByPlayer(player);
    }
