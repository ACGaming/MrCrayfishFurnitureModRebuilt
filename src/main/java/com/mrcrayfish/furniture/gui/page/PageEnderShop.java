...
public class PageEnderShop extends RecipePage
{
    public PageEnderShop()
    {
        super("endershop");
    }
    ...
    public void draw(GuiRecipeBook gui, int x, int y, int mouseX, int mouseY, float partialTicks)
    {
        for(int i = 0; i < recipes.size(); i++)
        {
            ...
            gui.getFontRenderer().drawString("x" + data.getPrice(), px + 68, py + 4, 0);
        }
    }
    ...
    {
        return I18n.format("cfm.recipe_book.page.endershop");
    }
}
