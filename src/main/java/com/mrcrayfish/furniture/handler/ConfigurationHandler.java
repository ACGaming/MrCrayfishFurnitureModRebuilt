...
public class ConfigurationHandler
{
    ...
    public static boolean ender_21 = true, ender_22 = true, ender_23 = true, ender_24 = true, ender_25 = true, ender_26 = true, ender_27 = true, ender_28 = true, ender_29 = true, ender_30 = true;
    ...
    private static void updateEnabledRecipes()
    {
        ...
        mine_2 = config.getBoolean("minebay-2", CATEGORY_RECIPE_SETTINGS, mine_2, "1 Skeleton Skull for 8 Emerald");
        mine_3 = config.getBoolean("minebay-3", CATEGORY_RECIPE_SETTINGS, mine_3, "1 Saddle for 4 Emerald");
        mine_4 = config.getBoolean("minebay-4", CATEGORY_RECIPE_SETTINGS, mine_4, "1 Horse Spawn Egg for 8 Emerald");
        mine_5 = config.getBoolean("minebay-5", CATEGORY_RECIPE_SETTINGS, mine_5, "1 Diamond Horse Armour for 8 Diamond");
        ...
        ender_4 = config.getBoolean("ender-4", CATEGORY_RECIPE_SETTINGS, ender_4, "1 Printer for 28 Gold Ingot");
        ender_5 = config.getBoolean("ender-5", CATEGORY_RECIPE_SETTINGS, ender_5, "1 Microwave for 20 Gold Ingot");
        ender_6 = config.getBoolean("ender-6", CATEGORY_RECIPE_SETTINGS, ender_6, "1 Blender for 16 Gold Ingot");
        ender_7 = config.getBoolean("ender-7", CATEGORY_RECIPE_SETTINGS, ender_7, "1 Toaster for 16 Gold Ingot");
        ender_8 = config.getBoolean("ender-8", CATEGORY_RECIPE_SETTINGS, ender_8, "1 Bird Bath for 32 Iron Ingot");
        ender_9 = config.getBoolean("ender-9", CATEGORY_RECIPE_SETTINGS, ender_9, "1 Cookie Jar for 2 Emerald");
        ender_10 = config.getBoolean("ender-10", CATEGORY_RECIPE_SETTINGS, ender_10, "2 Plate for 12 Iron Ingot");
        ender_11 = config.getBoolean("ender-11", CATEGORY_RECIPE_SETTINGS, ender_11, "1 Chopping Board for 8 Iron Ingot");
        ender_12 = config.getBoolean("ender-12", CATEGORY_RECIPE_SETTINGS, ender_12, "16 Soap for 1 Emerald");
        ender_13 = config.getBoolean("ender-13", CATEGORY_RECIPE_SETTINGS, ender_13, "1 Dishwasher for 44 Gold Ingot");
        ender_14 = config.getBoolean("ender-14", CATEGORY_RECIPE_SETTINGS, ender_14, "2 Daylight Sensor for 3 Emerald");
        ender_15 = config.getBoolean("ender-15", CATEGORY_RECIPE_SETTINGS, ender_15, "1 Lamp for 12 Iron Ingot");
        ender_16 = config.getBoolean("ender-16", CATEGORY_RECIPE_SETTINGS, ender_16, "2 Ceiling Light for 8 Iron Ingot");
        ender_17 = config.getBoolean("ender-17", CATEGORY_RECIPE_SETTINGS, ender_17, "8 Light Switch for 16 Iron Ingot");
        ender_18 = config.getBoolean("ender-18", CATEGORY_RECIPE_SETTINGS, ender_18, "2 Note Block for 4 Emerald");
        ender_19 = config.getBoolean("ender-19", CATEGORY_RECIPE_SETTINGS, ender_19, "4 Activator Rail for 8 Iron Ingot");
        ender_20 = config.getBoolean("ender-20", CATEGORY_RECIPE_SETTINGS, ender_20, "4 Golden Rail for 8 Iron Ingot");
        ender_21 = config.getBoolean("ender-21", CATEGORY_RECIPE_SETTINGS, ender_21, "4 Detector Rail for 12 Iron Ingot");
        ender_22 = config.getBoolean("ender-22", CATEGORY_RECIPE_SETTINGS, ender_22, "4 Rail for 4 Iron Ingot");
        ender_23 = config.getBoolean("ender-23", CATEGORY_RECIPE_SETTINGS, ender_23, "2 Sea Lantern for 5 Emerald");
        ender_24 = config.getBoolean("ender-24", CATEGORY_RECIPE_SETTINGS, ender_24, "1 Modern Light for 12 Iron Ingot");
        ender_25 = config.getBoolean("ender-25", CATEGORY_RECIPE_SETTINGS, ender_25, "1 Radio for 24 Gold Ingot");
        ender_26 = config.getBoolean("ender-26", CATEGORY_RECIPE_SETTINGS, ender_26, "1 Modern TV for 24 Gold Ingot");
        ender_27 = config.getBoolean("ender-27", CATEGORY_RECIPE_SETTINGS, ender_27, "2 TV Remote for 16 Iron Ingot");
        ender_28 = config.getBoolean("ender-28", CATEGORY_RECIPE_SETTINGS, ender_28, "1 Trampoline for 24 Iron Ingot");
