...
public class TileEntityOldWallCabinet extends TileEntityFurniture implements ISidedInventory
{
    private static final int[] slots = new int[]{0, 1, 2, 3, 4, 5, 6, 7, 8};

    public TileEntityOldWallCabinet()
    {
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        ...
        return new ContainerOldWallCabinet(playerInventory, this);
    }
}
